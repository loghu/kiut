...
class conexion{
	...
	public function recupera($correo){
		...
		echo "<script type='text/javascript'>
				alert('El correo no existe. Verifique que su correo que este registrado');
				window.location.href='index.php?ncapa=0';
			 </script>";
		}
	}

public function orden($p,$tam,$ha,$al,$can,$be,$tama)
{
	$this->p = $p;
	$this->tam= $tam;
	$this->ha= $ha;
